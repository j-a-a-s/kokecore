...
`deprecated`. No KOKE CORE package is stable during Alpha.
...
| `@kokecore/config`     | beta         | KOKE GROUP Platform | `0.2.0`        | 99.23 / 97.80 / 100 / 99.18 | Kaklen local link; reference consumer | Node 22, TS 5.8          | Environment schema remains product-shaped                                     | No               |
