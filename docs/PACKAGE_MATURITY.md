...
| `@kokecore/config`     | stable       | KOKE GROUP Platform | `0.2.0`        | 100 / 99.04 / 100 / 100     | Kaklen packaged artifact; reference consumer | Node 22, pnpm 8/9, TS 5.8 | Internal Alpha only; public publication remains prohibited                    | Internal only    |
...
The Config measurement and maturity were refreshed by TASK-CONFIG-001. Its
binding evidence is in
[`config/CONFIG_CONSUMPTION_GATE.md`](config/CONFIG_CONSUMPTION_GATE.md).
