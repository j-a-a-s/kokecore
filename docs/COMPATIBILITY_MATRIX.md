...
| ---------- | -------------------------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| Node.js    | `>=22 <25`                             | `>=22 <25`; CI and consumer contract use Node 22 | Node 22 is the minimum supported runtime and the certified integration baseline                    | Add newer majors only after the complete compatibility matrix passes              |
...
Only one stack major may move in an extraction cycle. Node.js support outside
`>=22 <25`, NestJS major changes, and TypeScript 6 adoption in Kaklen require
explicit approval and the complete compatibility matrix.
